	...
	<div id="wrapper">
		<div style="z-index: 10; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); background: white; position: fixed; top: 0; width: 100%; ">
			<div class="topnav" id="myTopnav">
			  ...
			  <a href="blog.php" class="nav_content" style="color: #00A2E8;">ব্লগ</a>
			...
			<?php } ?>
				...
				<div class="b_posts" id="post_area">
					...
					<form method="post" action="" enctype="multipart/formdata">
						<h4 style="color: #32BEF0;">পোস্ট টাইটেল লিখুনঃ</h4>
						<input type="text" required id="title" name=""  onfocusout="name_func2(this.value)" class="form-control" onfocus="name_func()" autocomplete="off" placeholder="পোস্টটির টাইটেল দিন" onkeyup="dunc()">
